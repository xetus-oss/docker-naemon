...
5. Optional Jabber notification support via [sendxmpp](http://sendxmpp.hostname.sk) (See below)
...
Jabber notification commands are added to the naemon configuration in the `notify_jabber_commands.cfg`. By default, there are two sets of commands which can be used for different scenarios, and their names are fairly intuitive. 
